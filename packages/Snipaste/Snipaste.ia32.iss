...
AppId={{4F4BB9B4-D07E-4245-8C0F-301FE59C2B14}
AppName=Snipaste
AppVersion=1.16.2
;AppVerName=Snipaste 1.16.2
AppPublisher=Snipaste
AppPublisherURL=https://zh.snipaste.com/index.html
AppSupportURL=https://zh.snipaste.com/index.html
AppUpdatesURL=https://zh.snipaste.com/index.html
...
OutputDir=.
OutputBaseFilename=Snipaste.Setup.ia32
Compression=lzma
...
[Files]
Source: ".\ia32\Snipaste.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\{cm:ProgramOnTheWeb,Snipaste}"; Filename: "https://zh.snipaste.com/index.html"
Name: "{group}\{cm:UninstallProgram,Snipaste}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\Snipaste"; Filename: "{app}\Snipaste.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\Snipaste.exe"; Description: "{cm:LaunchProgram,Snipaste}"; Flags: nowait postinstall skipifsilent
