...
OutputDir=.
OutputBaseFilename=TranslucentTB.Setup.arm64
Compression=lzma
...
[Files]
Source: ".\arm64\TranslucentTB.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: ".\arm64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
